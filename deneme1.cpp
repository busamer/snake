...
YONLER yeniYon(){	//klavyede basılı olan yönü döndürür
	klavyeKontrol();
	if(tuslar['A']){
		return sol;
	}else if(tuslar['S']){
...
void YILAN::olustur(int size){ //yilanin parcalarinin bilgilerini OLUŞTURUR
...
void YILAN::sahneyeYaz(){ //dolu elemanların x ve ylerini sahneye YAZAR
	int i = 0;
...
void SAHNE::sinirYaz(){ //sahneye sınırları YAZAR
